# test_mcp_local_python_executor_http.py
import asyncio
...
async def test_simple_python():
    ...
    server_url = "http://localhost:8056"
        ...
        async with streamablehttp_client(f"{server_url}/mcp", auth=None) as (
            ...
            async with ClientSession(read, write) as session:
                ...
                result = await session.call_tool(
                    ...
                    {
                        "code": """
print("Hello from Local MCP HTTP!")
x = 10
y = 20
...
async def test_with_dependencies():
    ...
    print("\n" + "=" * 60)
    print("TEST 2: Python Scripts with Dependencies (HTTP)")
    print("=" * 60)
...
async def run_all_tests():
    """Run all test suites."""
    print("Starting MCP Local Python Executor HTTP Tests")
    print("=" * 60)
